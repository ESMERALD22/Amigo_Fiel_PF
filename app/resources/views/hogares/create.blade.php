...
@section('content')
<h1><b><center>REGISTRO DE HOGAR TEMPORAL</center></h1>
...
<form action="{{ route('hogares.store')}}" method="POST" enctype="multipart/form-data"   >
    ...
    <div class="mb-3">
        ...
        <input id="telefono1" name="telefono1" type="number" class="form-control" tabindex="3" maxlength="8" required>
    </div>

    <div class="mb-3">
        <label for="" class="form-label">Teléfono 2 :</label>
        <input id="telefono2" name="telefono2" type="number" class="form-control" tabindex="3" maxlength="8" required>
    </div>
    ...
    <div class="mb-3">
        ...
        <input id="descripcionLugar" name="descripcionLugar" type="text" class="form-control" tabindex="3" required>
    </div>
    ...
    <div class="mb-3">
        ...
        <input id="tiempoDisponible" name="tiempoDisponible" type="text" class="form-control" tabindex="3" required>
    </div>
